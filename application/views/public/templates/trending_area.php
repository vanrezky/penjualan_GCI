						  ...
						  <div class="tab-content">
							<div role="tabpanel" class="tab-pane active" id="home">
								<div id="owl-example" class="owl-carousel">
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item1.jpg" alt="" />
								  ...
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item2.jpg" alt="" />
										<div class="tr-add-cart">
											<ul>
												<li><a class="fa fa-shopping-cart tr_cart" href="#"></a></li>
												<li><a class="tr_text" href="#">ADD TO CART</a></li>
								  ...
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item3.jpg" alt="" />
										<div class="tr-add-cart">
											<ul>
												<li><a class="fa fa-shopping-cart tr_cart" href="#"></a></li>
												<li><a class="tr_text" href="#">ADD TO CART</a></li>
								  ...
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item4.jpg" alt="" />
										<div class="tr-add-cart">
											<ul>
												<li><a class="fa fa-shopping-cart tr_cart" href="#"></a></li>
												<li><a class="tr_text" href="#">ADD TO CART</a></li>
								  ...
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item12.jpg" alt="" />
										<div class="tr-add-cart">
											<ul>
												<li><a class="fa fa-shopping-cart tr_cart" href="#"></a></li>
												<li><a class="tr_text" href="#">ADD TO CART</a></li>
								  ...
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item13.jpg" alt="" />
										<div class="tr-add-cart">
											<ul>
												<li><a class="fa fa-shopping-cart tr_cart" href="#"></a></li>
												<li><a class="tr_text" href="#">ADD TO CART</a></li>
							...
							<div role="tabpanel" class="tab-pane" id="profile">
								<div id="owl-example-two" class="owl-carousel">
								  ...
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item7.jpg" alt="" />
										<div class="tr-add-cart">
											<ul>
												<li><a class="fa fa-shopping-cart tr_cart" href="#"></a></li>
												<li><a class="tr_text" href="#">ADD TO CART</a></li>
								  ...
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item14.jpg" alt="" />
										<div class="tr-add-cart">
											<ul>
												<li><a class="fa fa-shopping-cart tr_cart" href="#"></a></li>
												<li><a class="tr_text" href="#">ADD TO CART</a></li>
								  ...
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item5.jpg" alt="" />
										<div class="tr-add-cart">
											<ul>
												<li><a class="fa fa-shopping-cart tr_cart" href="#"></a></li>
												<li><a class="tr_text" href="#">ADD TO CART</a></li>
								  ...
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item6.jpg" alt="" />
										<div class="tr-add-cart">
											<ul>
												<li><a class="fa fa-shopping-cart tr_cart" href="#"></a></li>
												<li><a class="tr_text" href="#">ADD TO CART</a></li>
								  ...
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item15.jpg" alt="" />
										<div class="tr-add-cart">
											<ul>
												<li><a class="fa fa-shopping-cart tr_cart" href="#"></a></li>
												<li><a class="tr_text" href="#">ADD TO CART</a></li>
								  ...
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item8.jpg" alt="" />
										<div class="tr-add-cart">
											<ul>
												<li><a class="fa fa-shopping-cart tr_cart" href="#"></a></li>
												<li><a class="tr_text" href="#">ADD TO CART</a></li>
								  ...
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item9.jpg" alt="" />
										<div class="tr-add-cart">
											<ul>
												<li><a class="fa fa-shopping-cart tr_cart" href="#"></a></li>
												<li><a class="tr_text" href="#">ADD TO CART</a></li>
							...
							<div role="tabpanel" class="tab-pane" id="messages">
								<div id="owl-example-three" class="owl-carousel">
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item10.jpg" alt="" />
										<div class="tr-add-cart">
											<ul>
												<li><a class="fa fa-shopping-cart tr_cart" href="#"></a></li>
												<li><a class="tr_text" href="#">ADD TO CART</a></li>
								  ...
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item16.jpg" alt="" />
										<div class="tr-add-cart">
											<ul>
												<li><a class="fa fa-shopping-cart tr_cart" href="#"></a></li>
												<li><a class="tr_text" href="#">ADD TO CART</a></li>
								  ...
								  <div class="item">
									<div class="item-img">
										<img src="<?= base_url('assets/public/');?>images/t_item11.jpg" alt="" />
										<div class="tr-add-cart">
											<ul>
												<li><a class="fa fa-shopping-cart tr_cart" href="#"></a></li>
												<li><a class="tr_text" href="#">ADD TO CART</a></li>
