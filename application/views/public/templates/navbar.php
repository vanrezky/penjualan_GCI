		...
		<div class="container">
			<div class="nav_left floatleft">
				...
				<div class="cat_mega_menu">
						...
						<div class="cat_img">
							<img src="<?= base_url('assets/public/');?>images/menu_cat.png" alt="" />
						</div>
				</div>
			</div>
			...
			<div class="nav_right floatright">
				<a href="cart.html"><img src="<?= base_url('assets/public/');?>images/bag.png" alt="Bag" />cart: 2 items</a>
				<div class="cart_menu">
					<div class="cart_items">
						<div class="c_item_img floatleft">
							<a href="product-detail.html"><img src="<?= base_url('assets/public/');?>images/c_item1.jpg" alt="" /></a>
						</div>
						<div class="c_item_totals floatleft">
							...
							<div class="close_icon_cart floatleft">
								<img src="<?= base_url('assets/public/');?>images/close.png" alt="" />
							</div>
						</div>
					</div>
					<div class="cart_items">
						<div class="c_item_img floatleft">
							<a href="product-detail.html"><img src="<?= base_url('assets/public/');?>images/c_item2.jpg" alt="" /></a>
						</div>
						<div class="c_item_totals floatleft">
							<div class="c_item_totals_detail floatleft">
								<a href="product-detail.html"><h5>men’s fashion blue jean coat</h5></a>
								...
								<ul>
									...
									<li class="img-nav">
										<div class="container">
											...
											<div class="row in1">
												<div class="col-md-6">
													<a href="#"><img src="<?= base_url('assets/public/');?>images/menu_cat.png" class="img-responsive" alt=""/></a>
												</div>
												<div class="col-md-6">
												</div>
												<div class="clearfix"></div>
