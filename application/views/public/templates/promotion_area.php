								...
								<div class="promotion_left">
									<div class="promotion_top">
										<div class="images_box">
											<img src="<?= base_url('assets/public/');?>images/promo_img1.jpg" alt="" />
										</div>
										...
										<div class="hover_images">
											<img src="<?= base_url('assets/public/');?>images/promo_img11.jpg" alt="" />
										</div>
									</div>
									<div class="promotion_bottom">
										<div class="images_box">
											<img src="<?= base_url('assets/public/');?>images/promo_img2.jpg" alt="" />
										</div>
										...
										<div class="hover_images_bottom hover_images">
											<img src="<?= base_url('assets/public/');?>images/promo_img22.jpg" alt="" />
										</div>
									</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="promotion_right">
									<div class="promotion_bottom promotion_bottom_t">
										<div class="images_box">
											<img src="<?= base_url('assets/public/');?>images/promo_img3.jpg" alt="" />
										</div>
										...
										<div class="hover_images_bottom hover_images">
											<img src="<?= base_url('assets/public/');?>images/promo_img33.jpg" alt="" />
										</div>
									</div>
									<div class="promotion_top promotion_bottom_b">
										<div class="images_box">
											<img src="<?= base_url('assets/public/');?>images/promo_img4.jpg" alt="" />
										</div>
										...
										<div class="hover_images">
											<img src="<?= base_url('assets/public/');?>images/promo_img44.jpg" alt="" />
										</div>
									</div>
